...
type MsgVerifyTransferIntentProof struct {
	...
	ProofHeight ProofHeight `protobuf:"bytes,4,opt,name=proof_height,json=proofHeight,proto3" json:"proof_height"`
	// the commitment key path.
	MerklePath MerklePath `protobuf:"bytes,5,opt,name=merkle_path,json=merklePath,proto3" json:"merkle_path"`
	// the value which is proven.
	Value []byte `protobuf:"bytes,6,opt,name=value,proto3" json:"value,omitempty"`
	// optional time delay
	TimeDelay uint64 `protobuf:"varint,7,opt,name=time_delay,json=timeDelay,proto3" json:"time_delay,omitempty"`
	// optional block delay
	BlockDelay uint64 `protobuf:"varint,8,opt,name=block_delay,json=blockDelay,proto3" json:"block_delay,omitempty"`
}
...
func (m *MsgVerifyTransferIntentProof) GetProofHeight() ProofHeight {
	if m != nil {
...
func (m *MsgVerifyTransferIntentProof) GetMerklePath() MerklePath {
	if m != nil {
		return m.MerklePath
	}
	return MerklePath{}
...
func (m *MsgVerifyTransferIntentProof) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *MsgVerifyTransferIntentProof) GetTimeDelay() uint64 {
	if m != nil {
		return m.TimeDelay
	}
	return 0
...
func (m *MsgVerifyTransferIntentProof) GetBlockDelay() uint64 {
	if m != nil {
		return m.BlockDelay
	}
	return 0
...
var fileDescriptor_6d0c0bfb695dacb5 = []byte{
	...
	,
}
...
func (m *MsgVerifyTransferIntentProof) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.BlockDelay != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.BlockDelay))
		i--
		dAtA[i] = 0x40
	}
	if m.TimeDelay != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.TimeDelay))
		i--
		dAtA[i] = 0x38
	}
	if len(m.Value) > 0 {
...
func (m *MsgVerifyTransferIntentProof) Size() (n int) {
	...
	if m.TimeDelay != 0 {
		n += 1 + sovTx(uint64(m.TimeDelay))
	}
	if m.BlockDelay != 0 {
		n += 1 + sovTx(uint64(m.BlockDelay))
	}
	return n
}
